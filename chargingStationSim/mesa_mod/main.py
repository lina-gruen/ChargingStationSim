...
COOKIECUTTER_DIR = "mesa_mod/cookiecutter-mesa_mod"
...
@click.command()
@click.option(
    "--no-input", is_flag=True, help="Do not prompt user for custom mesa_mod model input."
)
